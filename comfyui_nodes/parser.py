from . import lark_embed
from math import ceil


prompt_parser = lark_embed.Lark(
	r"""
!start: (prompt | /[][():|]/+)*
...
class CutTransform(lark_embed.Transformer):
...
def get_steps(tree):
	...
	class CollectSteps(lark_embed.Visitor):
...
def at_step(step, filters, tree):
	class AtStep(lark_embed.Transformer):
...
class PromptSchedule(object):
	...
	def _parse(self):
		...
		except lark_embed.exceptions.LarkError as e:
